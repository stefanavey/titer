...
#'   \item{maxRBA_d<X>}{a named vector containing the discrete maxRBA endpoint with a cutoff at <X>}
#'   \item{...}{Other named vectors containing discrete maxRBA endpoints}
#' }
#' @seealso \code{lm, nls}
#' @author Stefan Avey
#' @export
